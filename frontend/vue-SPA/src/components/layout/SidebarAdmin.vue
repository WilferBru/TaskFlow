<template>        
     <aside class="w-20 bg-white dark:bg-black shadow-md p-3">
      <nav class="space-y-2 flex flex-col h-full">
        <RouterLink
          ...
          :class="{ 'text-green-400 font-semibold': $route.name === 'home' }"
        >
            <HomeIcon />
        ...
        <RouterLink
          :to="{ name: 'task' }"
          class="flex flex-col items-center px-3 py-3 rounded text-gray-300 hover:bg-gray-600"
          :class="{ 'text-green-400 font-semibold': $route.name === 'task' }"
        >
            <TaskIcon />
            <p class="text-xs mt-2">Tareas</p>
        </RouterLink>
        
        <RouterLink
          :to="{ name: '' }"
          class="flex flex-col items-center px-3 py-3 rounded text-gray-300 hover:bg-gray-600"
          :class="{ 'text-green-400 font-semibold': $route.name === '' }"
        >
            <UsersIcon />
        ...
        <RouterLink
          ...
          :class="{ 'text-green-400 font-semibold': $route.name === 'profile' }"
        >
